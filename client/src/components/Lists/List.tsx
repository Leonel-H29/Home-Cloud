  ...
  return (
    <>
      ...
      <ButtonGroup size="lg" className="mb-2">
        <Button title="Upload a file">{IconPlusFile}</Button>
        <Button title="Upload a Directory">{IconPlusDirectory}</Button>
        <Button title="Download a File">{IconDownload}</Button>
        <div>
          <label>
            Ubicación:
            <input
          ...
          <Button onClick={handleListClick}>Right</Button>
        </div>
      </ButtonGroup>
